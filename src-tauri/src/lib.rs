...
pub fn run() {
    ...
    #[cfg(debug_assertions)]
    {
        let header = "/* eslint-disable */\n// @ts-nocheck\n// AUTO-GENERATED by tauri-specta. DO NOT EDIT.\n// Source: src-tauri/src/lib.rs::build_specta_builder.\n// Regenerate (Linux/macOS): `cd src-tauri && cargo test --test specta_codegen generate_bindings_ts`.\n// Regenerate (Windows):     `cd src-tauri && MDOWNREVIEW_GEN_BINDINGS_ONLY=1 cargo run`.\n\n";
        ...
        // so precision loss is theoretical.
        ...
        // `MDOWNREVIEW_GEN_BINDINGS_ONLY=1 cargo run` instead.
