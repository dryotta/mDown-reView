...
Two stable line schemas share this rotating file (issue #264 / PR3). The canonical home for the field reference and gating model is [`docs/observability.md`](../observability.md):
